    ...
    <div class="row mt-5">
        <div class="col-8 m-auto">
            ...
            <form action="proses.php" method="post">
                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Nama Lokasi</label>
                    <input type="text" name="lokasi" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Tangggal</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="jumlah_peserta" class="form-control" id="exampleInputPassword1">
                </div>
